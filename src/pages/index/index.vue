...
<script>
  ...
  import alert from "@/components/common/alert-1"
...
<style scoped="">
  ...
  .mainfour .container1 .left{
    width:336px;
    height:302px;
    background-color:#808080;
    float:left;
  }
  .mainfour .container1 .right{
    width:648px;
    height:302px;
    background-color:#808080;
    float:left;
  }
  .mainfour .container1 .right .top{
    width:648px;
    height:151px;
    background-color:#808080;
    float:left;
  ...
  .mainfour .container1 .right .bottom{
    width:648px;
    height:151px;
    background-color:#808080;
    float:left;
